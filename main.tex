...
\begin{table}[htbp]
\centering
\caption{R1: Unconditional Reversal, Primary Gate (Development Window, Net of Costs)}
\begin{tabular}{lrr}
\toprule
Factor & Coefficient & $t$-statistic \\
\midrule
Intercept (daily, bps) & $-$7.45 & $-$5.04 \\
Mkt-RF & 0.969 & 28.02 \\
SMB & 1.094 & 20.84 \\
HML & $-$0.252 & $-$7.08 \\
RMW & $-$0.568 & $-$11.15 \\
...
ST\_Rev & 0.562 & 6.85 \\
\midrule
\multicolumn{3}{l}{$R^2 = 0.904$, $n = 1{,}738$ days, Newey-West SE (10 lags)} \\
\bottomrule
\end{tabular}
\label{tab:r1-primary}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{R2: Volume-Conditioned Reversal, Net and Gross (Development Window)}
\begin{tabular}{lrrrr}
\toprule
& \multicolumn{2}{c}{Net of Costs} & \multicolumn{2}{c}{Gross (Pre-Cost)} \\
Factor & Coef. & $t$-stat & Coef. & $t$-stat \\
\midrule
Intercept (daily, bps) & $-$8.71 & $-$4.68 & $-$2.72 & $-$1.46 \\
Mkt-RF & 0.810 & 13.82 & 0.810 & 13.84 \\
SMB & 1.111 & 13.29 & 1.111 & 13.31 \\
HML & $-$0.298 & $-$5.10 & $-$0.298 & $-$5.11 \\
RMW & $-$0.382 & $-$5.79 & $-$0.382 & $-$5.81 \\
CMA & $-$0.072 & $-$0.73 & $-$0.072 & $-$0.73 \\
MOM & $-$0.129 & $-$5.20 & $-$0.129 & $-$5.20 \\
ST\_Rev & 0.326 & 5.93 & 0.326 & 5.93 \\
\midrule
\multicolumn{5}{l}{$R^2 = 0.778$, $n = 1{,}738$ days, Newey-West SE (10 lags)} \\
\bottomrule
\end{tabular}
\label{tab:r2-primary}
\end{table}
\begin{figure}[htbp]
    \centering
...
\begin{table}[htbp]
\centering
\caption{V1 and V2: Compression Forecasting, Development and Holdout}
\begin{tabular}{lrrr}
\toprule
Specification & Window & Mean Coefficient & Newey-West $t$ \\
\midrule
V1 (own-history) & Dev & $-$0.004265 & $-$6.883 \\
V1 (own-history) & Holdout & $-$0.003348 & $-$3.385 \\
V2 (sector-relative) & Dev & $-$0.003816 & $-$7.016 \\
V2 (sector-relative) & Holdout & $-$0.002556 & $-$3.062 \\
\bottomrule
\end{tabular}
\label{tab:v1v2-summary}
\end{table}
\begin{figure}[htbp]
    \centering
...
\begin{table}[htbp]
\centering
\caption{K0: Forecaster Horse Race, Mean Absolute Error}
\begin{tabular}{lrr}
\toprule
Forecaster & MAE (10-day) & MAE (30-day) \\
\midrule
TRAIL20 (trailing 20d vol) & 0.1751 & 0.1644 \\
GARCH(1,1) & 0.1810 & 0.1621 \\
Compression decile mean & 0.1980 & --- \\
\bottomrule
\end{tabular}
\label{tab:k0-horserace}
